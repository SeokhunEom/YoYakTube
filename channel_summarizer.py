...
from yoyaktube.llm import LLMClient
from yoyaktube.transcript import collect_transcript
from yoyaktube.utils import extract_video_id, create_summary_markdown
from yoyaktube.constants import FULL_SUMMARY_PROMPT
...
def summarize_videos(videos: List[Dict], llm_client: LLMClient) -> Dict[str, str]:
    ...
    for i, video in enumerate(videos, 1):
        ...
        try:
            ...
            # 요약 생성
            from yoyaktube.llm import ChatMessage
            messages = [
