...
class TestCollectTranscript:
    ...
    def test_collect_transcript_success_korean(self, mock_youtube_api, sample_video_id):
        ...
        from yoyaktube.transcript import collect_transcript
    ...
    @patch('yoyaktube.transcript.YouTubeTranscriptApi')
    def test_collect_transcript_fallback_to_english(self, mock_youtube_api, sample_video_id):
        ...
        def mock_find_transcript(languages):
            if "ko" in languages:
                ...
                mock_snippets = [
                    ...
                    MockSnippet("Testing is very important part of software development.", 4.5, 5.2)
                ]
                mock_transcript.fetch.return_value = mock_snippets
    ...
    @patch('yoyaktube.transcript.YouTubeTranscriptApi')
    def test_collect_transcript_custom_languages(self, mock_youtube_api, sample_video_id):
        ...
        mock_transcript.fetch.return_value = [
            {"start": 0.0, "duration": 4.5, "text": "こんにちは、今日はテストについて話します。"}
        ]
        mock_transcript_list.find_transcript.return_value = mock_transcript
    ...
    @patch('yoyaktube.transcript.YouTubeTranscriptApi')
    def test_collect_transcript_no_transcript_available(self, mock_youtube_api, sample_video_id):
        """Test when no transcript is available"""
        from yoyaktube.transcript import collect_transcript
        
        mock_youtube_api.list_transcripts.side_effect = TranscriptsDisabled(sample_video_id)
    ...
    @patch('yoyaktube.transcript.YouTubeTranscriptApi')
    def test_collect_transcript_no_requested_languages(self, mock_youtube_api, sample_video_id):
    ...
    @patch('yoyaktube.transcript.YouTubeTranscriptApi')
    def test_collect_transcript_generated_subtitle(self, mock_youtube_api, sample_video_id):
    ...
    @patch('yoyaktube.transcript.YouTubeTranscriptApi')
    def test_collect_transcript_empty_transcript(self, mock_youtube_api, sample_video_id):
...
class TestCollectTranscriptEntries:
    ...
    @patch('yoyaktube.transcript.YouTubeTranscriptApi')
    def test_collect_transcript_entries_success(self, mock_youtube_api, sample_video_id):
        """Test successful transcript entries collection"""
        from yoyaktube.transcript import collect_transcript_entries
    ...
    @patch('yoyaktube.transcript.YouTubeTranscriptApi')
    def test_collect_transcript_entries_with_custom_languages(self, mock_youtube_api, sample_video_id):
        """Test transcript entries collection with custom languages"""
        from yoyaktube.transcript import collect_transcript_entries
        
        expected_entries = [
            {"start": 0.0, "duration": 4.5, "text": "Hello, today we will talk about testing."}
        ]
    ...
    @patch('yoyaktube.transcript.YouTubeTranscriptApi')
    def test_collect_transcript_entries_no_transcript(self, mock_youtube_api, sample_video_id):
    ...
    @patch('yoyaktube.transcript.YouTubeTranscriptApi')
    def test_collect_transcript_entries_empty_list(self, mock_youtube_api, sample_video_id):
    ...
    @patch('yoyaktube.transcript.YouTubeTranscriptApi')
    def test_collect_transcript_entries_malformed_data(self, mock_youtube_api, sample_video_id):
